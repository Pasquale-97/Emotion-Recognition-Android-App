...
public class todayData extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView calmString = (TextView) v.findViewById(R.id.calm_string);
        ...
        int excitedData = db.getTodayExcitedData();
        int happyData = db.getTodayHappyData();
        int calmData = db.getTodayCalmData();
        int sadData = db.getTodaySadData();
        int angryData = db.getTodayAngryData();
        ...
        data.setValueFormatter(new todayData.DecimalRemover(new DecimalFormat("###,###,###")));
//      data.setValueFormatter(new todayData.MyYAxisValueFormatter());
