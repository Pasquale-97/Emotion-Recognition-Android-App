...
public class thisMonthData extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        int excitedData = db.getMonthExcitedData();
        int happyData = db.getMonthHappyData();
        int calmData = db.getMonthCalmData();
        int sadData = db.getMonthSadData();
        int angryData = db.getMonthAngryData();
        ...
        data.setValueFormatter(new thisMonthData.DecimalRemover(new DecimalFormat("###,###,###")));
//      data.setValueFormatter(new thisMonthData.MyYAxisValueFormatter());
